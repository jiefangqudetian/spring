package com.pa.agentbank.drs.constant;
...
public class FTPConstant { 
	...
	public static HashMap<String, String> jobExecuteMap = new HashMap<String, String>();
	...
	static {
		REPLYCODE.put(120, "服务已就绪,在nnn分钟后开始。");
		...
		REPLYCODE.put(215, "NAME 系统类型，其中，NAME 是 Assigned Numbers 文档中所列正式系统名称。");
